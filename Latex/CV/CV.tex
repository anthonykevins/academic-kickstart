...
\hypersetup{
    ...
    pdfkeywords={Anthony Kevins, CV, political science, public opinion, social policy},
    bookmarksopen=true,
...
\begin{minipage}[t]{.25\linewidth}
	\raggedleft
	\scriptsize \textbf{November 2025}\\
\end{minipage}%
\normalsize
...
\phantomsection
\addcontentsline{toc}{subsection}{General Training}\textit{General Training:} Leadership Training, Imperial Business School (2025);
