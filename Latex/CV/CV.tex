...
\\
	...
	n.d. & Naomi Lightman and Anthony Kevins. "When Caring Comes at a Cost: Psychological Wellbeing of Unpaid and Paid Carers and the Role of Social Expenditure", \textit{Journal of European Social Policy} (Forthcoming).
...
\section{Teaching}
\phantomsection
\addcontentsline{toc}{subsection}{Undergraduate}\textit{Undergraduate}: British Politics and Government (Loughborough University); Comparative European Politics (Loughborough University); Comparative Political Economy (Loughborough University); Dissertation (Loughborough University); Introduction to Philosophy (Loughborough University); Political Institutions: Western Countries, the European Union and International Institutions (Aarhus University); Politics and Government (Loughborough University); Politics: Contemporary Europe (McGill University); Research Design (Loughborough University); Smart Scholarship (Loughborough University).\\
\hfill \break
\phantomsection
