...
\begin{minipage}[t]{.13\linewidth}
	\raggedleft
	\scriptsize \textbf{Novembre 2025}\\
\end{minipage}%
\normalsize
...
\phantomsection
\addcontentsline{toc}{subsection}{Formation générale}\textit{Formation générale} : « Leadership Training », Imperial Business School (2025); « New Lecturers Programme », Université de Loughborough (2019-2022).\\
\hfill \break
\phantomsection
