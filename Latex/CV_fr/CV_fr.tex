...
\begin{minipage}[t]{.13\linewidth}
	\raggedleft
	\scriptsize \textbf{Décembre 2024}\\
\end{minipage}%
\normalsize
...
\vspace{-2em}
\begin{longtblr}[entry=none,label=none]{@{} l X @{}}
	n.d. & Anthony Kevins et Naomi Lightman. « Satisfaction with Social Care in the UK: Assessing the Interactive Effects of Age and Ideology », \textit{International Journal of Social Welfare} (OnlineFirst). \href{https://doi.org/10.1111/ijsw.12710}{doi.org/10.1111/ijsw.12710}
